...
function Item(props) {
    return (
        <div className="group relative w-44 md:w-64 bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden mb-6">
            ...
            <button className="absolute top-3 right-3 z-10 bg-white/80 backdrop-blur-sm p-2 rounded-full text-gray-400 hover:text-red-500 transition-colors shadow-sm opacity-0 group-hover:opacity-100">
            ...
            <div className="p-4">
                ...
                <div className="flex items-center justify-between mb-2">
                    <span className="text-[11px] font-bold uppercase tracking-wider text-indigo-500 bg-indigo-50 px-2 py-0.5 rounded">
                        {props.category || "Mens"}
                    </span>
                ...
                {/* Title */}
                <Link to={`/Product/${props.id}`}>
                    <h1 className="text-[15px] font-semibold text-gray-800 line-clamp-1 hover:text-indigo-600 transition-colors">
                        {props.name}
                    </h1>
                </Link>
                ...
                <p className="text-gray-500 text-[12px] mt-1 line-clamp-2 leading-relaxed">
                    Premium quality material with modern design for a perfect fit and style.
                </p>
